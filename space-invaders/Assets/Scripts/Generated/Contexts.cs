...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, UnityEngine.Transform>(
            ...
            (e, c) => ((Common.ViewComponent)c).Value));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithView(this GameContext context, UnityEngine.Transform Value) {
        return ((Entitas.EntityIndex<GameEntity, UnityEngine.Transform>)context.GetEntityIndex(Contexts.View)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
