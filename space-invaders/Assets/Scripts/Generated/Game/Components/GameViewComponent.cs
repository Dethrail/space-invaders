...
public partial class GameEntity {
    ...
    public Common.ViewComponent view { get { return (Common.ViewComponent)GetComponent(GameComponentsLookup.View); } }
    public bool hasView { get { return HasComponent(GameComponentsLookup.View); } }

    public void AddView(UnityEngine.Transform newValue) {
        var index = GameComponentsLookup.View;
        var component = (Common.ViewComponent)CreateComponent(index, typeof(Common.ViewComponent));
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceView(UnityEngine.Transform newValue) {
        var index = GameComponentsLookup.View;
        var component = (Common.ViewComponent)CreateComponent(index, typeof(Common.ViewComponent));
        component.Value = newValue;
