...
namespace Common
{
    public sealed class EnemyObjectService : Service
    {
        private int _entityCounter;

        public EnemyObjectService(Contexts contexts) : base(contexts)
        {
            _entityCounter = 0;
        }
        ...
        public GameEntity CreateDefaultSymbol(char c, Vector3 position)
        {
            var entity = contexts.game.CreateEntity();
            // entity.AddSymbol(c, false, null);
            // entity.AddId(_entityCounter);
